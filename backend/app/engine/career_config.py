...
AUTO_MECHANIC_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("20000.00"),
...
AIRCRAFT_MECHANIC_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("31000.00"),
...
BANKER_CONFIG = JobCareerConfig(
    job_key="banker",
    display_name="Banker",
    base_pay_reference=Decimal("25500.00"),
...
CHEF_CONFIG = JobCareerConfig(
    job_key="chef",
    display_name="Chef",
    base_pay_reference=Decimal("17500.00"),
...
CLEANER_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("12000.00"),
...
WAREHOUSE_OPERATOR_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("16000.00"),
...
RETAIL_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("13000.00"),
...
DELIVERY_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("15000.00"),
...
REAL_ESTATE_AGENT_CONFIG = JobCareerConfig(
    ...
    base_pay_reference=Decimal("24000.00"),
