...
def create_app() -> FastAPI:
    ...
    application.include_router(personal_shocks.router, prefix="/personal", tags=["Personal Shocks"])
    ...
    application.include_router(day.router, prefix="/day", tags=["day"])
    ...
    application.include_router(marketplace.router, prefix="/marketplace", tags=["marketplace"])
    ...
    application.include_router(deals.router, prefix="/deals", tags=["Deals"])
    ...
    application.include_router(strategy.router, prefix="/strategy", tags=["Strategy"])
    ...
    application.include_router(strategic_planning.router, prefix="/strategic-planning", tags=["Strategic Planning"])
    application.include_router(commitment.router, prefix="/commitment", tags=["Commitment"])
    application.include_router(world_memory.router, prefix="/world-memory", tags=["World Memory"])
    application.include_router(population_pressure.router, prefix="/population", tags=["Population Pressure"])
    application.include_router(debt_behavior.router, prefix="/debt", tags=["Debt Behavior"])
    application.include_router(wealth_progression.router, prefix="/wealth", tags=["Wealth Progression"])
    application.include_router(reputation_trust.router, prefix="/reputation", tags=["Reputation Trust"])
    application.include_router(contract_timing.router, prefix="/contracts", tags=["Contract Timing"])
