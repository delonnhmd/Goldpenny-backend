...
Tables intentionally LEFT locked (no policy = deny all):
  Player-private data
    ...
    player_businesses, player_inventory, purchase_actions, housing_actions,
    job_actions, contribution_events, xgp_transactions, side_income_actions,
    basket_purchases, business_daily_snapshots,
