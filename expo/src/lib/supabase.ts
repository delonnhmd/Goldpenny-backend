...
// still works during development. No bundled fallback credentials — V1 must
// fail loudly when env is missing rather than ship hardcoded project keys.
const SUPABASE_URL =
...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  throw new Error(
    '[supabase] Missing EXPO_PUBLIC_SUPABASE_URL or EXPO_PUBLIC_SUPABASE_ANON_KEY. ' +
      ...
      'Bundled fallback credentials were removed in the Phase 4 blocker pass.',
  );
}
