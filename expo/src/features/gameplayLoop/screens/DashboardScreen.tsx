...
const TIMED_ACTIVITY_PRESETS: TimedActivityCardPreset[] = [
  {
    ...
    timeRule: `Costs 1 unit every ${BALANCE.REALTIME.MINUTES_PER_UNIT} min while running.`,
  },
  {
    id: 'watch_movie',
    title: 'Watch Movie',
              ...
              style={[
                styles.rideshareResultCard,
                {
                  backgroundColor: rideshareResultGlow.interpolate({
                    inputRange: [0, 1],
                    outputRange: [alpha(theme.ui.positive, 0.06), alpha(theme.ui.positive, 0.24)],
                  }),
                  borderColor: rideshareResultGlow.interpolate({
                    inputRange: [0, 1],
                    outputRange: [theme.ui.positive, theme.ui.positive],
                  }),
                },
              ]}
            >
