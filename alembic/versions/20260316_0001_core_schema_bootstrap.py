...
def upgrade() -> None:
    ...
    if not _table_exists(bind, "players"):
        op.create_table(
            ...
            sa.Column("pending_reward_points", sa.Float(), nullable=False, server_default="0"),
            sa.Column("pending_token_amount", sa.Float(), nullable=False, server_default="0"),
            sa.Column("total_lifetime_token_claimed", sa.Float(), nullable=False, server_default="0"),
            sa.Column("reward_eligibility_status", sa.String(length=20), nullable=False, server_default="eligible"),
            ...
            sa.Column("wallet_linked", sa.Boolean(), nullable=False, server_default=sa.text("false")),
            ...
            sa.Column("lifetime_contribution_score", sa.Float(), nullable=False, server_default="0"),
            sa.Column("last_claimed_epoch", sa.Integer(), nullable=True),
            sa.Column("is_reward_eligible", sa.Boolean(), nullable=False, server_default=sa.text("false")),
